...
Verify the predicted addresses, 980M/20M allocation, direct Safe ownership, 1% buy/sell fee, 100 ETH virtual reserve, 1 ETH purchase cap, 25 ETH buyer-funded threshold, capped pool seed, exact excess-inventory burn formula, graduation-gated treasury vesting, migration adapter, 12-month LP locker, and paused rename state.
