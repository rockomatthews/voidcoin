...
library UniMath {
    ...
    function nextPriceFromAmount0(uint160 sqrtP, uint128 liquidity, uint256 amount0) internal pure returns (uint160) {
    ...
    function nextPriceFromAmount1(uint160 sqrtP, uint128 liquidity, uint256 amount1) internal pure returns (uint160) {
