...
contract DeployVOIDCoinV2 is Script {
    ...
    function run() external returns (VOIDV2Launch launch, VOIDV2BuyRouter buyRouter) {
        ...
        bytes32 deploymentSalt = vm.envBytes32("V2_DEPLOYMENT_SALT");
        ...
        require(deploymentSalt != bytes32(0), "V2_DEPLOYMENT_SALT required");
        ...
        vm.startBroadcast();
        launch = new VOIDV2Launch{salt: deploymentSalt}(
            safe, IVOIDV2PositionManager(POSITION_MANAGER), IERC20(USDC), initialTokenURI
        );
